...
```sh
git clone https://github.com/esize/MacAutoSetup.git ~/Projects/MacAutoSetup
...
```
bash <(curl -fsSL https://raw.githubusercontent.com/esize/MacAutoSetup/main/bootstrap-nogit.sh)
```
